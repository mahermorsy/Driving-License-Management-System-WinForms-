...
namespace DVLD.Licenses.Local_Licenses.Controls
{
    public partial class ctrlDriverLicenses : UserControl
    {
        ...
        public void LoadInfo(int DriverID)
        {
            ...
            if (_Driver == null)
            {
                MessageBox.Show("No Driver Found For ID ", DriverID.ToString(),MessageBoxButtons.OK);
                return;
            }
        ...
        public void LoadInfoByPersonID(int PersonID)
        {
            ...
            if (_Driver == null)
            {
                MessageBox.Show("No Driver Linked With Person ID ", PersonID.ToString(), MessageBoxButtons.OK);
                return;
            }
